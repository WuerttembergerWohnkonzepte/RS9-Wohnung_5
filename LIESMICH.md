...
7. **Adresse der veroeffentlichten Seite eintragen.** In der index.html
...
8. **Erster Monat der Mietsubvention.** Die Excel weist den ersten
   Betrag in der Spalte "heute" aus und zaehlt ihn einmal. Im Expose
   steht dafuer, wie schon bei der Nr. 3, der Dezember 2026. Passt der
   Monat nicht, ist es eine Zeile in der Tabelle in Kapitel 06 und eine
   im Text darunter. Die Summe von 8.060 EUR bleibt davon unberuehrt.
...
11. **Kostenrahmen Modernisierung.** Im Kapitel 07 steht bewusst kein
...
aus den Unterlagen dieser Einheit.
    ...
    Mietsubvention                 8.060 EUR   siehe Staffelung unten

Die Mietsubvention ist mit **8.060 EUR** angesetzt, wie in Zelle M44
der Kalkulation:

    Dezember 2026       140 EUR                 140 EUR
    2027 bis 2028       120 EUR je Monat      2.880 EUR
    2029 bis 2031       100 EUR je Monat      3.600 EUR
    2032 bis 2034        40 EUR je Monat      1.440 EUR
    Summe                                     8.060 EUR

Im Rechenmodell der index.html steht dafuer

    sub:[120, 120, 100, 100, 100, 40, 40, 40, 0, 0]

Das sind die Monatsbetraege fuer die Jahre 1 bis 10 nach dem Kauf, also
2027 bis 2036. Die 140 EUR fuer den Dezember 2026 liegen davor und sind
...
erst nach drei Jahren an, die Kalkulation dagegen schon 2029 bei einer
Vollfinanzierung ab heute. Das Expose rechnet damit vorsichtiger.
Angeglichen wird es, indem im Rechenmodell die Zeile
...
schon bei der Nr. 2 und der Nr. 3.
...
damit Garten, Flur, Bad und WC, der Rest kommt beim Wischen. `07` ist
fuer das dritte Zimmer frei gehalten.
...
Die Bildstreifen sind waagerecht wischbar. Am Rechner liegen vier
Bilder nebeneinander und es gibt Pfeile am Rand, auf dem Tablet zwei,
auf dem Telefon eines. Ein Klick auf ein Bild oeffnet es gross in der
